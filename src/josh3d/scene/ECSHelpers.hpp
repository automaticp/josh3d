...
// Returns true if the tag was set succesfully, false if it was already set.
template<typename TagT>
inline bool set_tag(entt::handle handle) noexcept {
...
template<typename TagT>
inline bool unset_tag(entt::handle handle) noexcept {
