...
template<> struct gl_channel_type<GLubyte> { static constexpr PixelDataType value = PixelDataType::UByte; };
template<> struct gl_channel_type<GLfloat> { static constexpr PixelDataType value = PixelDataType::Float; };


template<typename PixelT> struct gl_pixel_channel_type;
template<typename PixelT>
    requires requires { typename pixel_traits<PixelT>; }
struct gl_pixel_channel_type<PixelT> : gl_channel_type<typename pixel_traits<PixelT>::channel_type> {};


template<typename PixelT> struct gl_pixel_format;
template<> struct gl_pixel_format<pixel::RED>  { static constexpr PixelDataFormat value = PixelDataFormat::Red;  };
template<> struct gl_pixel_format<pixel::RG>   { static constexpr PixelDataFormat value = PixelDataFormat::RG;   };
template<> struct gl_pixel_format<pixel::RGB>  { static constexpr PixelDataFormat value = PixelDataFormat::RGB;  };
template<> struct gl_pixel_format<pixel::RGBA> { static constexpr PixelDataFormat value = PixelDataFormat::RGBA; };

template<> struct gl_pixel_format<pixel::REDF>  { static constexpr PixelDataFormat value = PixelDataFormat::Red;  };
template<> struct gl_pixel_format<pixel::RGF>   { static constexpr PixelDataFormat value = PixelDataFormat::RG;   };
template<> struct gl_pixel_format<pixel::RGBF>  { static constexpr PixelDataFormat value = PixelDataFormat::RGB;  };
template<> struct gl_pixel_format<pixel::RGBAF> { static constexpr PixelDataFormat value = PixelDataFormat::RGBA; };

template<typename PixelT>
concept inferrable_pixel_traits = requires {
    { gl_pixel_format<PixelT>::value }       -> same_as_remove_cvref<PixelDataFormat>;
    { gl_pixel_channel_type<PixelT>::value } -> same_as_remove_cvref<PixelDataType>;
};
...
template<detail::inferrable_pixel_traits PixelT>
struct pixel_pack_traits<PixelT> {
public:
    static constexpr PixelDataFormat format = detail::gl_pixel_format<PixelT>::value;
    static constexpr PixelDataType   type   = detail::gl_pixel_channel_type<PixelT>::value;
};
