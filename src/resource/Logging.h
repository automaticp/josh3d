...
inline void enable_glbinding_logger(std::ostream& os) {
    ...
    /*
        ...
        Thus, we use the Global Logging Callback to check for errors,
    ...
    */
    ...
    auto log_if_error = [&os](FunctionCall* call) {
    ...
    glbinding::setCallbackMaskExcept(
		CallbackMask::Logging | CallbackMask::ParametersAndReturnValue,
		{ "glGetError" }
	);
	glbinding::setLogCallback(log_if_error);
